// components.js — injecte la nav, le footer et les boutons flottants
// dans chaque page via #nav-placeholder / #footer-placeholder.
// La page active est déduite de data-page sur <body>.
